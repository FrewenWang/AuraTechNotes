...
如何删除、关闭anaconda的base环境
1、打开cmd通过此命令来关闭自动激活的base环境：
...
————————————————
版权声明：本文为CSDN博主「cvyoutian」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/m0_46114594/article/details/110696046
